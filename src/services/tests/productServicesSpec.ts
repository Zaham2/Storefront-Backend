...
const productServicesStore = new ProductServices()
const userStore = new UserStore()
const productStore = new ProductStore()
const orderStore = new OrderStore()

/*to test this method we need:

- At least 1 User
- At least 1 Order
- At least 6 Products
- At least 6 order_products (individual orders)

*/
describe('Testing Get 5 most popular products (ones with most sales',()=>{
    ...
    it('Get top 5 products',async ()=>{
        const top5 = await productServicesStore.getTopFiveProducts()
